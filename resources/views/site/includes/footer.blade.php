            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        ...
                        <p class="heading-text">{{$setting->site_about}}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{$setting->site_phone}}</a>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{$setting->site_mail}}</a>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">{{$setting->sub_address}}</p>
                        </div>
                    </div>
                </div>
            </div>
